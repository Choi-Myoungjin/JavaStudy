...
<script>
	...
	function del(num, photo){
		...
		location.href = "del3.bo?num="+num + "&photo=" + photo;
	...
	function delok(id, num){
		...
		location.href = "del3.comment?id="+id + "&num=" + num;
	}
...
<!--관광정보 게시글페이지 -->
		...
		<div>
			...
			<form name="comment1" method="post"  class="comment1" action="comment3write.comment">
				<div class="com1">
					<div>
						<ul>
