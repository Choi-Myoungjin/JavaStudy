...
<head>
	...
	<%
		...
		String num = request.getParameter("num11");
		String name = request.getParameter("name11");
		String content = request.getParameter("content11");
		String photoONE = request.getParameter("photo11");
	%>
<body>
	<!-- header 페이지 -->
	<header class="header">
...
<!-- admin -->
	...
	<form name="myform" method="post" enctype="multipart/form-data" action="adminco.bo">
		...
		<ul class="login pdt20 adarea">
			<li>
				...
				<label for="idd" class="readonly">여행지 이름을 입력하세요</label>
				<input type="text" name="title" id="title" title="여행지 이름입력해 주세요" value="<%=name %>">
			</li>
			<li>
			...
			<li class="paddinggo">
				<input type="hidden" value="<%=photoONE %>" name="photoONE">
